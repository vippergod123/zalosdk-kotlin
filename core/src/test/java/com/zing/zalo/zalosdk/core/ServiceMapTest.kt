...
{
     private val RESULT = ""
...
//          mockkObject(ServiceMapManager)
     ...
     fun noLoadIfCached()
     {
          ...
          //3. verify
          verify(exactly = 0) { httpClientFactory.newRequest(any(), any()) }
     }
     ...
     fun downloadServiceMapTestInDevMode()
     {
          ...
          every { request1.send().getText() } returns "ABC"
          every { request2.send().getText() } returns RESULT
...
//          //3. verify
          ...
          val testUrlCentralized = ServiceMapManager.urlFor(ServiceMapManager.KEY_URL_CENTRALIZED, WEB_LOGIN_PATH)
